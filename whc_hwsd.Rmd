...
```{r}
df <- rbeni::nc_to_df(paste0("/alphadata01/bstocker/data/soil/hwsd/hwsd_wieder/data/", zid, "_SAND.nc4"), paste0(zid, "_SAND")) %>%
  rename( fsand = myvar ) %>%
  left_join(
    rbeni::nc_to_df(paste0("/alphadata01/bstocker/data/soil/hwsd/hwsd_wieder/data/", zid, "_CLAY.nc4"), paste0(zid, "_CLAY")) %>%
      rename( fclay = myvar ),
    by = c("lon", "lat")
  ) %>%
  left_join(
    rbeni::nc_to_df(paste0("/alphadata01/bstocker/data/soil/hwsd/hwsd_wieder/data/", zid, "_OC.nc4"), paste0(zid, "_OC")) %>%
      rename( forg = myvar ),
    by = c("lon", "lat")
  ) %>%
  left_join(
    rbeni::nc_to_df(paste0("/alphadata01/bstocker/data/soil/hwsd/hwsd_wieder/data/", zid, "_GRAVEL.nc4"), paste0(zid, "_GRAVEL")) %>%
...
arr_sr <- df_sr %>% 
  df_to_grid("whc", paste0("/alphadata01/bstocker/data/soil/hwsd/hwsd_wieder/data/", zid, "_SAND.nc4"))
...
write_nc2(
  var = arr_sr, 
  varnam = "whc", 
  filnam_template = paste0("/alphadata01/bstocker/data/soil/hwsd/hwsd_wieder/data/", zid, "_SAND.nc4"), 
  outfilnam = paste0("/alphadata01/bstocker/data/soil/hwsd/hwsd_wieder/data_calculated/", zid, "_sr_WHC.nc"),
  lonnam_template = "lon", 
  latnam_template = "lat"
  )
write_nc2(
  ...
  varnam = "whc", 
  filnam_template = paste0("/alphadata01/bstocker/data/soil/hwsd/hwsd_wieder/data/", zid, "_SAND.nc4"), 
  outfilnam = paste0("/alphadata01/bstocker/data/soil/hwsd/hwsd_wieder/data_calculated/", zid, "_bl_WHC.nc"),
  lonnam_template = "lon", 
  latnam_template = "lat"
  )

## read NetCDF as test
test <- rbeni::read_nc_onefile(filn = paste0("/alphadata01/bstocker/data/soil/hwsd/hwsd_wieder/data_calculated/", zid, "_sr_WHC.nc"))
print(dim(test$vars$whc))

## regrid to half degree
system(paste0("cdo remapbil,gridfile_halfdeg.txt /alphadata01/bstocker/data/soil/hwsd/hwsd_wieder/data_calculated/", zid, "_sr_WHC.nc /alphadata01/bstocker/data/soil/hwsd/hwsd_wieder/data_calculated_halfdeg/", zid, "_sr_WHC.nc"))

system(paste0("cdo remapbil,gridfile_halfdeg.txt /alphadata01/bstocker/data/soil/hwsd/hwsd_wieder/data_calculated/", zid, "_bl_WHC.nc /alphadata01/bstocker/data/soil/hwsd/hwsd_wieder/data_calculated_halfdeg/", zid, "_bl_WHC.nc"))

## read NetCDF as test
test <- rbeni::read_nc_onefile(filn = paste0("/alphadata01/bstocker/data/soil/hwsd/hwsd_wieder/data_calculated_halfdeg/", zid, "_bl_WHC.nc"))
print(dim(test$vars$whc))

...
gg <- plot_map3(nc_tenthdeg, varnam = "cwdx20", breaks = c(seq(0, 100, by = 20), 150, 200, 300, 500, 1000, Inf), latmin = -55, latmax = 80,
...
gg <- plot_map3(nc_tenthdeg, varnam = "cwdx40", breaks = c(seq(0, 100, by = 20), 150, 200, 300, 500, 1000, Inf), latmin = -55, latmax = 80,
          spacing = "constant", maxval = 6000, combine = FALSE, colorscale = viridis::cividis, legend_title = "(mm)")
gg$ggmap <- gg$ggmap + 
...
gg <- plot_map3(nc_tenthdeg, varnam = "cwdx100", breaks = c(seq(0, 100, by = 20), 150, 200, 300, 500, 1000, Inf), latmin = -55, latmax = 80,
          spacing = "constant", maxval = 6000, combine = FALSE, colorscale = viridis::cividis, legend_title = "(mm)")
gg$ggmap <- gg$ggmap + 
...
gg <- df_cwdx %>% 
  ...
  plot_map3(varnam = "cwdx40", lonmin = -10, lonmax = 5, latmin = 35, latmax = 45, breaks = c(seq(0, 100, by = 20), 150, 200, 300, 500, 1000, Inf), spacing = "constant")

## italy
gg <- df_cwdx %>% 
  dplyr::filter(lon > 7.5 & lon < 20 & lat > 36 & lat < 47) %>% 
  plot_map3(varnam = "cwdx40", lonmin = 7.5, lonmax = 20, latmin = 36, latmax = 47, breaks = c(seq(0, 100, by = 20), 150, 200, 300, 500, 1000, Inf), spacing = "constant")

## europe
gg <- df_cwdx %>% 
  dplyr::filter(lon > -10 & lon < 25 & lat > 35 & lat < 55) %>% 
  plot_map3(varnam = "cwdx40", 
...
cowplot::plot_grid(gg$ggmap, gg$gglegend, ncol = 2, rel_widths = c(1, 0.2))
ggsave("fig/map_cwdx40_europe.pdf", width = 8, height = 6)
ggsave("fig/map_cwdx40_europe.png", width = 8, height = 6)
...
gg$ggmap <- gg$ggmap + 
  ...
  geom_path(data = df_rivers, aes(x = long, y = lat, group = group), color = "dodgerblue", size = 0.2)
cowplot::plot_grid(gg$ggmap, gg$gglegend, ncol = 2, rel_widths = c(1, 0.2))
ggsave("fig/map_cwdx40_wusa.pdf", width = 10, height = 6)
ggsave("fig/map_cwdx40_wusa.png", width = 10, height = 6)

## central asia
gg <- df_cwdx %>% 
  plot_map3(varnam = "cwdx40", lonmin = 45, lonmax = 95, latmin = 25, latmax = 47.5, 
            breaks = c(seq(0, 100, by = 20), 150, 200, 300, 500, 1000, Inf), 
            spacing = "constant",
            combine = FALSE, 
...
gg$ggmap <- gg$ggmap + 
  ...
  geom_path(data = df_rivers, aes(x = long, y = lat, group = group), color = "dodgerblue", size = 0.2)
cowplot::plot_grid(gg$ggmap, gg$gglegend, ncol = 2, rel_widths = c(1, 0.2))
ggsave("fig/map_cwdx40_casia.pdf", width = 9, height = 5)
ggsave("fig/map_cwdx40_casia.png", width = 9, height = 5)

## Amazon
gg <- df_cwdx %>% 
  plot_map3(varnam = "cwdx40", lonmin = -83, lonmax = -33, latmin = -25, latmax = 12, 
            breaks = c(seq(0, 100, by = 20), 150, 200, 300, 500, 1000, Inf), 
            spacing = "constant",
            combine = FALSE, 
            colorscale = viridis::cividis, legend_title = "(mm)"
...
gg$ggmap <- gg$ggmap + 
  ...
  geom_path(data = df_rivers, aes(x = long, y = lat, group = group), color = "dodgerblue", size = 0.2)
cowplot::plot_grid(gg$ggmap, gg$gglegend, ncol = 2, rel_widths = c(1, 0.2))
ggsave("fig/map_cwdx40_amazon.pdf", width = 9, height = 6)
ggsave("fig/map_cwdx40_amazon.png", width = 9, height = 6)
```
...
save(df, file = "data/df_zroot40.RData")
```

Regrid and plot.
```{r}
nc <- df_to_grid(df, varnam = "zroot_cwd40", lonnam = "lon", latnam = "lat")
write_nc2(nc, varnams = "zroot_cwd40", lon = df$lon %>% unique() %>% sort(), lat = df$lat %>% unique() %>% sort(), path = "data/zroot_cwd40.nc", make_zdim = FALSE)

system("cdo remapbil,gridfile_quartdeg.txt data/zroot_cwd40.nc data/zroot_cwd40_quartdeg.nc")
system("cdo remapbil,gridfile_tenthdeg.txt data/zroot_cwd40.nc data/zroot_cwd40_tenthdeg.nc")

nc_tenthdeg <- read_nc_onefile("data/zroot_cwd40_tenthdeg.nc", varnam = "zroot_cwd40")
nc_tenthdeg$vars$zroot_cwd40 <- nc_tenthdeg$vars$zroot_cwd40 / 1000   # convert to m
gg <- plot_map3(
  nc_tenthdeg, 
  varnam = "zroot_cwd40", 
  breaks = c(seq(0, 1, by = 0.2), 1.5, 2, 3, 5, 7, 10, 15, 20, Inf), 
  latmin = -55, latmax = 75,
  spacing = "constant", 
  colorscale = viridis::magma,
  combine = FALSE,
...
gg$ggmap <- gg$ggmap +
  labs(title = expression(italic(z)[CWDX40]))
cowplot::plot_grid(gg$ggmap, gg$gglegend, ncol = 2, rel_widths = c(1, 0.2))
ggsave("fig/map_zroot_cwd40.pdf", width = 10, height = 6)
ggsave("fig/map_zroot_cwd40.png", width = 10, height = 6)
```
...
gg$ggmap <- gg$ggmap + 
  ...
  geom_path(data = df_rivers, aes(x = long, y = lat, group = group), color = "dodgerblue", size = 0.1)
cowplot::plot_grid(gg$ggmap, gg$gglegend, ncol = 2, rel_widths = c(1, 0.2))
...
Regrid to 0.1 deg
```{r}
system("cdo remapbil,gridfile_tenthdeg.txt data/cwd_lue0_SIF.nc data/cwd_lue0_SIF_tenthdeg.nc")
system("cdo remapbil,gridfile_tenthdeg.txt data/cwd_lue0_nSIF.nc data/cwd_lue0_nSIF_tenthdeg.nc")
...
```{r}
## SIF
nc_tenthdeg <- read_nc_onefile("data/cwd_lue0_SIF_tenthdeg.nc", varnam = "cwd_lue0_SIF")
...
# plot_map3(nc_tenthdeg, varnam = "lambda_decay_SIF", breaks = c(seq(0, 100, by = 20), 150, 200, 300, 500, 1000, Inf), latmin = -55, latmax = 80,
#           spacing = "constant", maxval = 6000)
...
# plot_map3(nc_tenthdeg, varnam = "lambda_decay_nSIF", breaks = -(c(seq(0, 100, by = 20), 150, 200, 300, 500, 1000, Inf)), latmin = -55, latmax = 80,
#           spacing = "constant", maxval = 6000)
...
Regrid to 0.1 deg
```{r}
system("cdo remapbil,gridfile_tenthdeg.txt data/cwd_lue0_et.nc data/cwd_lue0_et_tenthdeg.nc")
system("cdo remapbil,gridfile_tenthdeg.txt data/cwd_lue0_fet.nc data/cwd_lue0_fet_tenthdeg.nc")
system("cdo remapbil,gridfile_tenthdeg.txt data/s0_teuling_et.nc data/s0_teuling_et_tenthdeg.nc")
```

Read half-degree global file and plot.
```{r}
## ET
nc_tenthdeg <- read_nc_onefile("data/cwd_lue0_et_tenthdeg.nc", varnam = "cwd_lue0_et")
gg <- plot_map3(nc_tenthdeg, 
                varnam = "cwd_lue0_et", 
                breaks = c(seq(0, 100, by = 20), 150, 200, 300, 500, 1000, Inf), 
                latmin = -55, latmax = 80,
...
## ET/Rn
nc_tenthdeg <- read_nc_onefile("data/cwd_lue0_fet_tenthdeg.nc", varnam = "cwd_lue0_fet")
gg <- plot_map3(nc_tenthdeg, 
                varnam = "cwd_lue0_fet", 
                breaks = c(seq(0, 100, by = 20), 150, 200, 300, 500, 1000, Inf), 
                latmin = -55, latmax = 80,
...
df_corr_bias <- df_corr %>% 
  mutate(bias_sif_10 = -log(cwdx10 / cwd_lue0_SIF),
         bias_sif_20 = -log(cwdx20 / cwd_lue0_SIF),
         bias_sif_40 = -log(cwdx40 / cwd_lue0_SIF),
         bias_sif_80 = -log(cwdx80 / cwd_lue0_SIF),
         bias_sif_100 = -log(cwdx100 / cwd_lue0_SIF),
         bias_sif_200 = -log(cwdx200 / cwd_lue0_SIF),
...
df_corr_bias %>%
  drop_na() %>% 
  pivot_longer(cols = 18:23, names_to = "return_period", values_to = "bias", names_prefix = "bias_sif_") %>%
...
ggsave("fig/bias_sif_dsif.pdf", width = 6, height = 4)
ggsave("fig/bias_sif_dsif.png", width = 6, height = 4)
...
df_corr_bias %>%
  ...
  pivot_longer(cols = 18:23, names_to = "return_period", values_to = "bias", names_prefix = "bias_sif_") %>%
  mutate(return_period = as.factor(as.integer(return_period))) %>%
  ggplot(aes(x = return_period, y = bias, fill = forest)) +
...
df_corr_bias %>%
  drop_na() %>% 
  dplyr::select(24:29) %>% 
  pivot_longer(1:6, names_to = "return_period", values_to = "bias", names_prefix = "bias_fet_") %>%
  mutate(return_period = as.factor(as.integer(return_period))) %>%
  ggplot(aes(x = return_period, y = bias)) +
  geom_violin(draw_quantiles = 0.5) +
...
df_corr_bias %>%
  drop_na() %>% 
  dplyr::select(16, 24:29) %>% 
  pivot_longer(2:7, names_to = "return_period", values_to = "bias", names_prefix = "bias_fet_") %>%
  mutate(return_period = as.factor(as.integer(return_period))) %>%
  ggplot(aes(x = return_period, y = bias, fill = forest)) +
  geom_boxplot(outlier.shape = NA) +
  labs(x = expression("Return period used for S"[CWDX]), y = expression("log(S"[dEF] ~ "/S"[CWDX] ~ ")")) +
...
linmod2 <- lm(cwd_lue0_SIF_log ~ cwdx40 + gti + wtd + factor(forest), data = df_sub)
summary(linmod2)
...
gg10 <- out$gg +
  ...
  labs(title = "10 year return period", 
       ...
       y = expression(italic(S)[dSIF] ~ " (mm)"))
gg10
save(gg10, file = "data/corr_cwd_lue0_SIF_gg10.RData")
ggsave("fig/corr_cwd_lue0_SIF_cwdx10.pdf", width = 6, height = 5)
ggsave("fig/corr_cwd_lue0_SIF_cwdx10.png", width = 6, height = 5)
...
gg20 <- out$gg +
  ...
  labs(title = "20 year return period", 
       ...
       y = expression(italic(S)[dSIF] ~ " (mm)"))
gg20
save(gg20, file = "data/corr_cwd_lue0_SIF_gg20.RData")
ggsave("fig/corr_cwd_lue0_SIF_cwdx20.pdf", width = 6, height = 5)
ggsave("fig/corr_cwd_lue0_SIF_cwdx20.png", width = 6, height = 5)
...
gg100 <- out$gg +
  ...
  labs(title = "100 year return period", 
       ...
       y = expression(italic(S)[dSIF] ~ " (mm)"))
gg100
save(gg100, file = "data/corr_cwd_lue0_SIF_gg100.RData")
ggsave("fig/corr_cwd_lue0_SIF_cwdx100.pdf", width = 6, height = 5)
ggsave("fig/corr_cwd_lue0_SIF_cwdx100.png", width = 6, height = 5)
...
gg200 <- out$gg +
  ...
  labs(title = "200 year return period", 
       ...
       y = expression(italic(S)[dSIF] ~ " (mm)"))
gg200
save(gg200, file = "data/corr_cwd_lue0_SIF_gg200.RData")
ggsave("fig/corr_cwd_lue0_SIF_cwdx200.pdf", width = 6, height = 5)
ggsave("fig/corr_cwd_lue0_SIF_cwdx200.png", width = 6, height = 5)

library(patchwork)
(gg10 + gg20) /
  (gg40 + gg100)
ggsave("fig/corr_cwd_lue0_SIF.pdf", width = 12, height = 10)
ggsave("fig/corr_cwd_lue0_SIF.png", width = 12, height = 10)
```
...
df_corr_biome <- df_corr %>% 
  dplyr::filter(biome_name != "Mangroves") %>% 
  group_by(biome_name) %>% 
  summarise(q10_cwdx40 = quantile(cwdx40, probs = 0.10, na.rm = TRUE),
            q25_cwdx40 = quantile(cwdx40, probs = 0.25, na.rm = TRUE),
            q50_cwdx40 = quantile(cwdx40, probs = 0.50, na.rm = TRUE),
            q75_cwdx40 = quantile(cwdx40, probs = 0.75, na.rm = TRUE),
            q90_cwdx40 = quantile(cwdx40, probs = 0.90, na.rm = TRUE),
...
## dSIF
out <- df_corr_biome %>% 
  analyse_modobs2("q10_cwdx40", "q10_cwd_lue0_SIF", label = FALSE, id = "biome_name", nlabels = 3)
gg_sif_10 <- out$gg + labs(title = "10% quantile by biome",
              x = expression(italic(S)[CWDX40] ~ " (mm)"),
              y = expression(italic(S)[dSIF] ~ " (mm)"))

out <- df_corr_biome %>% 
  analyse_modobs2("q25_cwdx40", "q25_cwd_lue0_SIF", label = FALSE, id = "biome_name", nlabels = 3)
gg_sif_25 <- out$gg + labs(title = "25% quantile by biome",
              x = expression(italic(S)[CWDX40] ~ " (mm)"),
              y = expression(italic(S)[dSIF] ~ " (mm)"))

out <- df_corr_biome %>% 
  analyse_modobs2("q50_cwdx40", "q50_cwd_lue0_SIF", label = FALSE, id = "biome_name", nlabels = 3)
gg_sif_50 <- out$gg + labs(title = "50% quantile by biome",
              x = expression(italic(S)[CWDX40] ~ " (mm)"),
              y = expression(italic(S)[dSIF] ~ " (mm)"))

out <- df_corr_biome %>% 
  analyse_modobs2("q75_cwdx40", "q75_cwd_lue0_SIF", label = FALSE, id = "biome_name", nlabels = 3)
gg_sif_75 <- out$gg + labs(title = "75% quantile by biome",
              x = expression(italic(S)[CWDX40] ~ " (mm)"),
              y = expression(italic(S)[dSIF] ~ " (mm)"))

out <- df_corr_biome %>% 
  analyse_modobs2("q90_cwdx40", "q90_cwd_lue0_SIF", label = FALSE, id = "biome_name", nlabels = 3)
...
## dEF
out <- df_corr_biome %>% 
  analyse_modobs2("q10_cwdx40", "q10_cwd_lue0_fet", label = FALSE, id = "biome_name", nlabels = 3)
gg_ef_10 <- out$gg + labs(title = "10% quantile by biome",
              x = expression(italic(S)[CWDX40] ~ " (mm)"),
              y = expression(italic(S)[dEF] ~ " (mm)"))

out <- df_corr_biome %>% 
  analyse_modobs2("q25_cwdx40", "q25_cwd_lue0_fet", label = FALSE, id = "biome_name", nlabels = 3)
gg_ef_25 <- out$gg + labs(title = "25% quantile by biome",
              x = expression(italic(S)[CWDX40] ~ " (mm)"),
              y = expression(italic(S)[dEF] ~ " (mm)"))

out <- df_corr_biome %>% 
  analyse_modobs2("q50_cwdx40", "q50_cwd_lue0_fet", label = FALSE, id = "biome_name", nlabels = 3)
gg_ef_50 <- out$gg + labs(title = "50% quantile by biome",
              x = expression(italic(S)[CWDX40] ~ " (mm)"),
              y = expression(italic(S)[dEF] ~ " (mm)"))

out <- df_corr_biome %>% 
  analyse_modobs2("q75_cwdx40", "q75_cwd_lue0_fet", label = FALSE, id = "biome_name", nlabels = 3)
gg_ef_75 <- out$gg + labs(title = "75% quantile by biome",
              x = expression(italic(S)[CWDX40] ~ " (mm)"),
              y = expression(italic(S)[dEF] ~ " (mm)"))

out <- df_corr_biome %>% 
  analyse_modobs2("q90_cwdx40", "q90_cwd_lue0_fet", label = FALSE, id = "biome_name", nlabels = 3)

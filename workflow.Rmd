...
Test plot.
```{r}
nc <- df_to_grid(df_hwsd, varnam = "whc_top", lonnam = "lon", latnam = "lat")
...
gg <- df %>% 
  ...
  plot_map3(varnam = "cwdx20", lonmin = -10, lonmax = 25, latmin = 35, latmax = 55, breaks = c(seq(0, 100, by = 20), 150, 200, 300, 500, 1000, Inf), spacing = "constant", 
            combine = FALSE)
gg$ggmap <- gg$ggmap + labs(title = "Maximum cumulative water deficit", subtitle = "20 year return period")
cowplot::plot_grid(gg$ggmap, gg$gglegend, ncol = 2, rel_widths = c(1, 0.2))
ggsave("fig/map_cwdx20_europe.pdf", width = 10, height = 10)

## western usa
gg <- df %>% 
  plot_map3(varnam = "cwdx20", lonmin = -125, lonmax = -90, latmin = 32.5, latmax = 47, breaks = c(seq(0, 100, by = 20), 150, 200, 300, 500, 1000, Inf), spacing = "constant", 
            combine = FALSE)
gg$ggmap <- gg$ggmap + labs(title = "Maximum cumulative water deficit", subtitle = "20 year return period")
cowplot::plot_grid(gg$ggmap, gg$gglegend, ncol = 2, rel_widths = c(1, 0.2))
...
gg$ggmap <- gg$ggmap + labs(title = "Implied rooting depth", subtitle = "20 year return period")
cowplot::plot_grid(gg$ggmap, gg$gglegend, ncol = 2, rel_widths = c(1, 0.2))

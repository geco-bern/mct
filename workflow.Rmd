...
```{r}
## 10 y return period
nc <- df_to_grid(df, varnam = "cwdx10", lonnam = "lon", latnam = "lat")
write_nc2(nc, varnams = "cwdx10", lon = df$lon %>% unique() %>% sort(), lat = df$lat %>% unique() %>% sort(), path = "data/cwdx10.nc", make_zdim = FALSE)
...
## 40 y return period
nc <- df_to_grid(df, varnam = "cwdx40", lonnam = "lon", latnam = "lat")
write_nc2(nc, varnams = "cwdx40", lon = df$lon %>% unique() %>% sort(), lat = df$lat %>% unique() %>% sort(), path = "data/cwdx40.nc", make_zdim = FALSE)

## 100 y return period
nc <- df_to_grid(df, varnam = "cwdx100", lonnam = "lon", latnam = "lat")
write_nc2(nc, varnams = "cwdx100", lon = df$lon %>% unique() %>% sort(), lat = df$lat %>% unique() %>% sort(), path = "data/cwdx100.nc", make_zdim = FALSE)

## 200 y return period
nc <- df_to_grid(df, varnam = "cwdx200", lonnam = "lon", latnam = "lat")
write_nc2(nc, varnams = "cwdx200", lon = df$lon %>% unique() %>% sort(), lat = df$lat %>% unique() %>% sort(), path = "data/cwdx200.nc", make_zdim = FALSE)
```
...
plot_map3(nc_halfdeg, varnam = "cwdx20", breaks = c(seq(0, 100, by = 20), 150, 200, 300, 500, 1000, Inf), latmin = -55, latmax = 80,
...
plot_map3(nc_halfdeg, varnam = "cwdx100", breaks = c(seq(0, 100, by = 20), 150, 200, 300, 500, 1000, Inf), latmin = -55, latmax = 80,
          spacing = "constant", maxval = 6000)
...
gg$ggmap <- gg$ggmap + 
  labs(title = "Maximum cumulative water deficit", subtitle = "20 year return period") +
  geom_path(data = df_rivers, aes(x = long, y = lat, group = group), color = "dodgerblue")

cowplot::plot_grid(gg$ggmap, gg$gglegend, ncol = 2, rel_widths = c(1, 0.2))

ggsave("fig/map_cwdx20_europe.pdf", width = 10, height = 8)
...
cowplot::plot_grid(gg$ggmap, gg$gglegend, ncol = 2, rel_widths = c(1, 0.2))
ggsave("fig/map_cwdx20_wusa.pdf", width = 20, height = 10)
...
cowplot::plot_grid(gg$ggmap, gg$gglegend, ncol = 2, rel_widths = c(1, 0.2))
ggsave("fig/map_cwdx20_casia.pdf", width = 15, height = 10)

## iran
gg <- df %>% 
  dplyr::filter(lon > 45 & lon < 70 & lat > 20 & lat < 40) %>% 
  plot_map3(varnam = "cwdx20", lonmin = 45, lonmax = 70, latmin = 20, latmax = 40, breaks = c(seq(0, 100, by = 20), 150, 200, 300, 500, 1000, Inf), spacing = "constant",
            combine = FALSE)
gg$ggmap <- gg$ggmap + labs(title = "Maximum cumulative water deficit", subtitle = "20 year return period")
cowplot::plot_grid(gg$ggmap, gg$gglegend, ncol = 2, rel_widths = c(1, 0.2))
ggsave("fig/map_cwdx20_iran.pdf", width = 10, height = 10)

## Amazon
gg <- df %>% 
  plot_map3(varnam = "cwdx20", lonmin = -70, lonmax = -30, latmin = -20, latmax = 5, 
            breaks = c(seq(0, 100, by = 20), 150, 200, 300, 500, 1000, Inf), 
            spacing = "constant",
            combine = FALSE, 
            colorscale = viridis::magma
...
cowplot::plot_grid(gg$ggmap, gg$gglegend, ncol = 2, rel_widths = c(1, 0.2))
ggsave("fig/map_cwdx20_amazon.pdf", width = 15, height = 10)
...
```{r}
## SIF
nc <- df_to_grid(df, varnam = "cwd_lue0_SIF", lonnam = "lon", latnam = "lat")
write_nc2(nc, varnams = "cwd_lue0_SIF", lon = df$lon %>% unique() %>% sort(), lat = df$lat %>% unique() %>% sort(), path = "data/cwd_lue0_SIF.nc", make_zdim = FALSE)

## nSIF
nc <- df_to_grid(df, varnam = "cwd_lue0_nSIF", lonnam = "lon", latnam = "lat")
write_nc2(nc, varnams = "cwd_lue0_nSIF", lon = df$lon %>% unique() %>% sort(), lat = df$lat %>% unique() %>% sort(), path = "data/cwd_lue0_nSIF.nc", make_zdim = FALSE)

## lambda_decay_SIF
nc <- df_to_grid(df, varnam = "lambda_decay_SIF", lonnam = "lon", latnam = "lat")
write_nc2(nc, varnams = "lambda_decay_SIF", lon = df$lon %>% unique() %>% sort(), lat = df$lat %>% unique() %>% sort(), path = "data/lambda_decay_SIF.nc", make_zdim = FALSE)

## lambda_decay_nSIF
nc <- df_to_grid(df, varnam = "lambda_decay_nSIF", lonnam = "lon", latnam = "lat")
write_nc2(nc, varnams = "lambda_decay_nSIF", lon = df$lon %>% unique() %>% sort(), lat = df$lat %>% unique() %>% sort(), path = "data/lambda_decay_nSIF.nc", make_zdim = FALSE)
```
...
plot_map3(nc_halfdeg, varnam = "cwd_lue0_SIF", breaks = c(seq(0, 100, by = 20), 150, 200, 300, 500, 1000, Inf), latmin = -55, latmax = 80,
          spacing = "constant", maxval = 6000)
...
plot_map3(nc_halfdeg, varnam = "cwd_lue0_nSIF", breaks = c(seq(0, 100, by = 20), 150, 200, 300, 500, 1000, Inf), latmin = -55, latmax = 80,
          spacing = "constant", maxval = 6000)
...
out <- df_corr %>% 
  filter(cwdx20 < 1000 & cwd_lue0_SIF < 1000) %>% # TEST XXX
  analyse_modobs2("cwdx20", "cwd_lue0_SIF", type = "heat")
out$gg

df_corr %>% 
  filter(cwdx20 < 1000 & cwd_lue0_nSIF < 1000) %>% # TEST XXX
  analyse_modobs2("cwdx20", "cwd_lue0_nSIF", type = "heat")

df_corr %>% 
  filter(cwdx20 > -1000 & lambda_decay_nSIF > -1000) %>% # TEST XXX
  analyse_modobs2("cwdx20", "lambda_decay_nSIF", type = "heat")
```
...
Then collect outputs using `rscript_collect_cwd_et0.R` and read the file. It's huge.
```{r}
load("data/df_cwd_et0.RData")

df <- df %>% 
  dplyr::select(lon, lat, cwd_lue0_et, cwd_lue0_fet, s0_teuling_et)
save(df, file = "data/df_sub_cwd_et0.RData")
```
...
## s0_teuling_et
nc <- df_to_grid(df %>% dplyr::select(lon, lat, s0_teuling_et), varnam = "s0_teuling_et", lonnam = "lon", latnam = "lat")
...
plot_map3(nc_halfdeg, varnam = "s0_teuling_et", breaks = c(seq(0, 100, by = 20), 150, 200, 300, 500, 1000, Inf), latmin = -55, latmax = 80,
          spacing = "constant", maxval = 6000)

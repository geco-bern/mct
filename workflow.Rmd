...
For the global application, combine WHCX and soil texture information into a global common data frame.
...
df_whc %>% 
  ...
  plot_map3(varnam = "whc_top", lonmin = -10, lonmax = 5, latmin = 35, latmax = 45)
```

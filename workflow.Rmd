...
```{r}
df_elv <- nc_to_df(
  "/Users/bestocke/data/etopo/ETOPO1_Bed_g_gef.tif_halfdeg.nc",
...
For global simulations, get soil parameters using the R script `rscript_calc_soilparams.R`.
...
Run script `rscript_get_et_mm.R` on Euler (submission file: `submit_get_et_mm.R`).

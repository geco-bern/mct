...
suppressMessages(calc_cwd_et0_byilon(5600, drop_data = FALSE, dirn = "~/mct/data/df_cwd_et0_2/"))
...
```{r}
out <- calc_cwd_lue0(df_data, df_inst, nam_lue = "fet", do_plot = TRUE, verbose = TRUE)
out$gg
out$cwd_lue0
```

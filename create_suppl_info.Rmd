...
gg_boxplot <- df_cwdx |> 
  ...
  ylim(0, 750) +
  theme_classic() +
  labs(y = expression(paste(italic("S")[CWDX80])), x = "CTI bin", title = "Red box")
...
gg_boxplot2 <- df_cwdx |> 
  ...
  ylim(0, 750) +
  theme_classic() +
  labs(y = expression(paste(italic("S")[CWDX80])), x = "CTI bin", title = "Blue box")
...
btm <- cowplot::plot_grid(gg_boxplot, gg_boxplot2,
                          ncol = 2, labels = c('c', 'd'))
cowplot::plot_grid(top, btm, ncol = 1, rel_heights = c(2, 0.4))
ggsave("fig/fig_topography_casia.png", width = 10, height = 12)
ggsave("fig/fig_topography_casia.pdf", width = 10, height = 12)
```
...
gg_boxplot <- df_cwdx |> 
  ...
  ylim(0, 300) +
  theme_classic() +
  labs(y = expression(paste(italic("S")[CWDX80])), x = "CTI bin")
...
ggsave("fig/fig_topography_wusa.pdf", width = 10, height = 12)
```
